...
import { deletePermanentAccount, getNotifications, onLogoutPress } from 'services/api/auth-api-actions';
...
const UserTab = (props: props) => {
  ...
  //     {
  //       text: 'Delete',
  //       onPress: () => deletePermanentAccount(),
  //     },
  //   ]);
  // };
          ...
          <ScrollView
            ...
            <TouchableOpacity
              ...
              onPress={() =>
                userInfo?.id
                  ? dispatch(onLogoutPress())
                  : props?.navigation?.navigate('Login',{isBack: true})
              }>
              <AntDesign
