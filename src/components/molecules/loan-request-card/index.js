...
const LoanRequestCard = ({item, style, onPress, isExpanded}) => {
  return (
    <TouchableOpacity onPress={onPress} style={{...styles.container}}>
      ...
      {isExpanded && (
        <>
          ...
          <Row style={{marginTop: mvs(10), justifyContent: 'flex-start'}}>
            <View style={{width: '40%'}}>
              <Bold label={'Amount of Loan :'} />
            </View>
            <View style={{flex: 1}}>
              <Regular color={colors.placeholder} label={'30000'} />
            </View>
          </Row>
          <Row style={{marginTop: mvs(10), justifyContent: 'flex-start'}}>
            <View style={{width: '40%'}}>
              <Bold label={'Amount of Installment :'} />
            </View>
            <View style={{flex: 1}}>
              <Regular color={colors.placeholder} label={'30000'} />
            </View>
          ...
          <Row style={{marginTop: mvs(10), justifyContent: 'flex-start'}}>
            <View style={{width: '40%'}}>
              <Bold label={'Reason of Loan :'} />
            </View>
            <View style={{flex: 1}}>
              <Regular color={colors.placeholder} label={'abc'} />
            </View>
          </Row>
        </>
      )}
